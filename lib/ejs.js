...
, compile: function () {
    ...
    try {
      if (opts.es6) {
        ...
        fn = new GeneratorFunction(exports.localsName + ', escape, include, rethrow, filters, echo', src);
      }
      else {
       fn = new Function(exports.localsName + ', escape, include, rethrow, filters, echo', src);
      }
    }
    catch(e) {
...
var    self = this;
    ...
    if (opts.es6) {
      returnedFn = function* (data) {
        ...
        return yield fn.apply(opts.context, [data || {}, escape, include, rethrow, filters, echo]);
      };
    } 
    else {
      returnedFn = function (data) {
        ...
        return fn.apply(opts.context, [data || {}, escape, include, rethrow, filters, echo]);
      };
    }
