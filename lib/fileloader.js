...
utils.shallowCopy(FileSelector.prototype, {
  ...
  // generic fn applier (you may use glob from npm to select files),  fn(filePath<string>, files<array<string>>):inFiles<array<string>>
...
var ContentLoader = function(fileSelector) {
...
utils.shallowCopy(ContentOutputter.prototype, {
  ...
  applyFn: function(fn) {
    ...
    this.contents.forEach(function (p, i) {
       self.contents[i][1] = fn.call(null, p);
    });
